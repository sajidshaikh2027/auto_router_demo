  ...
  final Map<String, _i24.PageFactory> pagesMap = {
    ...
    PageFoundRoute.name: (routeData) {
      ...
      final args = routeData.argsAs<PageFoundRouteArgs>(
          orElse: () => PageFoundRouteArgs(id: pathParams.getString('userId')));
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i9.PageFound(
          key: args.key,
...
class HomeWithBottomPageRoute extends _i24.PageRouteInfo<void> {
  const HomeWithBottomPageRoute({List<_i24.PageRouteInfo>? children})
      : super(
...
class PageFoundRouteArgs {
  ...
  @override
  String toString() {
    return 'PageFoundRouteArgs{key: $key, id: $id}';
  }
}
